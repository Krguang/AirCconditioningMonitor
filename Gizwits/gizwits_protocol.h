...
* @{
*/
#define PRODUCT_KEY "b1a6dd0b36b3432db9346552c63a1ccf"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "b613347871e24f24b987028a6d4cc31f"
...
* @{
*/
#define SW_KongTiao_BYTEOFFSET                    0
#define SW_KongTiao_BITOFFSET                     0
#define SW_KongTiao_LEN                           1
#define SW_ZhiBan_BYTEOFFSET                    0
#define SW_ZhiBan_BITOFFSET                     1
#define SW_ZhiBan_LEN                           1
#define SW_FuYa_BYTEOFFSET                    0
#define SW_FuYa_BITOFFSET                     2
#define SW_FuYa_LEN                           1
#define ZS_JiZuYunXing_BYTEOFFSET                    7
#define ZS_JiZuYunXing_BITOFFSET                     0
#define ZS_JiZuYunXing_LEN                           1
#define ZS_ZhiBanYunXing_BYTEOFFSET                    7
#define ZS_ZhiBanYunXing_BITOFFSET                     1
#define ZS_ZhiBanYunXing_LEN                           1
#define ZS_FuYaYunXing_BYTEOFFSET                    7
#define ZS_FuYaYunXing_BITOFFSET                     2
#define ZS_FuYaYunXing_LEN                           1
#define ZS_JiZuGuZhang_BYTEOFFSET                    7
#define ZS_JiZuGuZhang_BITOFFSET                     3
#define ZS_JiZuGuZhang_LEN                           1
#define ZS_GaoXiaoZuSe_BYTEOFFSET                    7
#define ZS_GaoXiaoZuSe_BITOFFSET                     4
#define ZS_GaoXiaoZuSe_LEN                           1

#define WenDuSet_RATIO                         1
#define WenDuSet_ADDITION                      0
#define WenDuSet_MIN                           0
#define WenDuSet_MAX                           999
#define ShiDuSet_RATIO                         1
#define ShiDuSet_ADDITION                      0
#define ShiDuSet_MIN                           0
#define ShiDuSet_MAX                           999
#define YaChaSet_RATIO                         1
#define YaChaSet_ADDITION                      0
#define YaChaSet_MIN                           0
#define YaChaSet_MAX                           999
#define WenDuZhi_RATIO                         1
#define WenDuZhi_ADDITION                      0
#define WenDuZhi_MIN                           0
#define WenDuZhi_MAX                           999
#define ShiDuZhi_RATIO                         1
#define ShiDuZhi_ADDITION                      0
#define ShiDuZhi_MIN                           0
#define ShiDuZhi_MAX                           999
#define YaChaZhi_RATIO                         1
#define YaChaZhi_ADDITION                      0
#define YaChaZhi_MIN                           0
#define YaChaZhi_MAX                           999
#define LengShuiFa_RATIO                         1
#define LengShuiFa_ADDITION                      0
#define LengShuiFa_MIN                           0
#define LengShuiFa_MAX                           999
#define ReShuiFa_RATIO                         1
#define ReShuiFa_ADDITION                      0
#define ReShuiFa_MIN                           0
#define ReShuiFa_MAX                           999
#define JiaShuiQi_RATIO                         1
#define JiaShuiQi_ADDITION                      0
#define JiaShuiQi_MIN                           0
#define JiaShuiQi_MAX                           999
/**@} */
...
typedef struct {
  bool valueSW_KongTiao;
  bool valueSW_ZhiBan;
  bool valueSW_FuYa;
  uint32_t valueWenDuSet;
  uint32_t valueShiDuSet;
  uint32_t valueYaChaSet;
  bool valueZS_JiZuYunXing;
  bool valueZS_ZhiBanYunXing;
  bool valueZS_FuYaYunXing;
  bool valueZS_JiZuGuZhang;
  bool valueZS_GaoXiaoZuSe;
  uint32_t valueWenDuZhi;
  uint32_t valueShiDuZhi;
  uint32_t valueYaChaZhi;
  uint32_t valueLengShuiFa;
  uint32_t valueReShuiFa;
  uint32_t valueJiaShuiQi;
} dataPoint_t;


/** Corresponding to the protocol "4.10 WiFi module control device" in the flag " attr_flags" */ 
typedef struct {
  uint8_t flagSW_KongTiao:1;
  uint8_t flagSW_ZhiBan:1;
  uint8_t flagSW_FuYa:1;
  uint8_t flagWenDuSet:1;
  uint8_t flagShiDuSet:1;
  uint8_t flagYaChaSet:1;
} attrFlags_t;
...
typedef struct {
  ...
  uint16_t valueWenDuSet;
  uint16_t valueShiDuSet;
  uint16_t valueYaChaSet;
} attrVals_t;
...
typedef struct {
  ...
  uint16_t valueWenDuZhi;
  uint16_t valueShiDuZhi;
  uint16_t valueYaChaZhi;
  uint16_t valueLengShuiFa;
  uint16_t valueReShuiFa;
  uint16_t valueJiaShuiQi;
} devStatus_t; 
